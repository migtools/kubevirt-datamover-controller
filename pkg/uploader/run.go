...
func LoadConfigFromEnv() (*UploaderConfig, error) {
	config := &UploaderConfig{
		...
		BSLResourceGroup:               os.Getenv(EnvBSLResourceGroup),
		BSLStorageAccount:              os.Getenv(EnvBSLStorageAccount),
		BSLStorageAccountKeyEnvVar:     os.Getenv(EnvBSLStorageAccountKeyEnvVar),
		BSLStorageAccountURI:           os.Getenv(EnvBSLStorageAccountURI),
		BSLSubscriptionID:              os.Getenv(EnvBSLSubscriptionID),
		BSLUseAAD:                      strings.EqualFold(os.Getenv(EnvBSLUseAAD), "true"),
		BSLActiveDirectoryAuthorityURI: os.Getenv(EnvBSLActiveDirectoryAuthorityURI),
