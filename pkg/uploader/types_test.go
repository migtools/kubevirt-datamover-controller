...
func TestEnvironmentVariableConstants(t *testing.T) {
	...
	expectedEnvVars := map[string]string{
		"common.EnvBSLProvider":                    "KUBEVIRT_DM_BSL_PROVIDER",
		"common.EnvBSLBucket":                      "KUBEVIRT_DM_BSL_BUCKET",
		"common.EnvBSLPrefix":                      "KUBEVIRT_DM_BSL_PREFIX",
		"common.EnvBSLRegion":                      "KUBEVIRT_DM_BSL_REGION",
		"common.EnvCredentialsFile":                "KUBEVIRT_DM_CREDENTIALS_FILE",
		...
		"common.EnvBSLStorageAccountKeyEnvVar":     "KUBEVIRT_DM_BSL_STORAGE_ACCOUNT_KEY_ENV_VAR",
		"common.EnvBSLStorageAccountURI":           "KUBEVIRT_DM_BSL_STORAGE_ACCOUNT_URI",
		"common.EnvBSLSubscriptionID":              "KUBEVIRT_DM_BSL_SUBSCRIPTION_ID",
		"common.EnvBSLUseAAD":                      "KUBEVIRT_DM_BSL_USE_AAD",
		"common.EnvBSLActiveDirectoryAuthorityURI": "KUBEVIRT_DM_BSL_ACTIVE_DIRECTORY_AUTHORITY_URI",
	}
	...
	envVarsToCheck := []struct {
		...
		{"common.EnvBSLProvider", common.EnvBSLProvider},
		{"common.EnvBSLBucket", common.EnvBSLBucket},
		{"common.EnvBSLPrefix", common.EnvBSLPrefix},
		{"common.EnvBSLRegion", common.EnvBSLRegion},
		{"common.EnvCredentialsFile", common.EnvCredentialsFile},
		{"EnvVMName", EnvVMName},
...
func TestDefaultConstants(t *testing.T) {
	...
	if common.DefaultCredentialsPath != "/credentials/cloud" {
		t.Errorf("common.DefaultCredentialsPath = %q, want %q", common.DefaultCredentialsPath, "/credentials/cloud")
	}
}
