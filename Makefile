...
KIND_CLUSTER ?= kubevirt-datamover-controller-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name kubevirt-datamover-controller-builder
	$(CONTAINER_TOOL) buildx use kubevirt-datamover-controller-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm kubevirt-datamover-controller-builder
	rm Dockerfile.cross
